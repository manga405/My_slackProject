...
exports.create = async (socket, data) => {
    try {
        ...
        const createdChannel = await channelService.readOne(channel._id);
        sendToUsers(socket.socketList, channel.members, `${REQUEST.CHANNEL}_${METHOD.CREATE}`, STATUS.ON, createdChannel);

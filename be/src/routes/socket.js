...
const onConnect = (socket) => {
    ...
    socket.on(`${REQUEST.AUTH}_${METHOD.UPDATE}`, (data) => authMdr(socket, data, authCtr.updateStatus));
    socket.on(`${REQUEST.AUTH}_${METHOD.READ}`, (data) => authMdr(socket, data, authCtr.read));
    ...
    socket.on(`${REQUEST.MESSAGE}_${METHOD.PIN}`, (data) => authMdr(socket, data, messageCtr.updatePin));
    ...
    socket.on(`${REQUEST.FILE}_${METHOD.READ}`, (data) => authMdr(socket, data, fileCtr.read));
}
